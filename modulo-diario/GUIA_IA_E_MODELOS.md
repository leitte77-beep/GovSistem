...
## 4. Referências disponíveis no workspace

A pasta `modelos/` contém referências reais para ampliar a aprendizagem:

- 13 PDFs de edições e atos do Diário Oficial, todos com texto extraível;
- 7 arquivos TXT com lei, decretos, portaria, edital, extrato, tabela e anexos.

Os PDFs e TXT podem ser enviados em conjunto em **Documentos oficiais → Modelos
documentais → documentos de treinamento**. Marque as referências desejadas como
“utilizadas pela IA” e gere uma proposta. A IA aprende a estrutura observada
(cabeçalho, ementa, artigos, listas, tabelas, anexos e assinaturas), sem copiar
automaticamente dados específicos dos documentos. A proposta deve ser revisada
e aprovada antes de virar versão oficial.

## 5. Criar um documento com IA
...
## 6. Listagens por tipo e estados
...
## 7. Aplicação ao ambiente (deploy das migrações)
...
## 10. Limitações reais (não fingidas)
...
- A aprendizagem aceita referências TXT UTF-8, PDF e DOCX; a proposta continua
  sujeita a revisão e aprovação humana e não altera modelos ativos sozinha.
