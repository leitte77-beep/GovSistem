...
"""
    ...
    has_word_body = any(section.template_html for section in config.sections)
...
<main class="doc-body">
{f'<h1 class="doc-title">{title}</h1>' if title and not has_word_body else ''}
{f'<p class="doc-summary">{summary}</p>' if summary and not has_word_body else ''}
{body}
</main>
{_footer_html(layout)}
</body>
