...
async def _build_matters(
    ...
    from app.api.public_v1.semantic import _render_snapshot_matters, _slug_by_matter

    slug_by_matter = await _slug_by_matter(db, matter_ids) if matter_ids else {}
