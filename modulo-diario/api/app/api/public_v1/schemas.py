...
class MatterSummary(BaseModel):
    ...
    slug: str | None = Field(None, description="Canonical human-readable slug")
...
class MatterDetailPublic(BaseModel):
    ...
    slug: str | None = Field(None, description="Canonical human-readable slug")
    edition: dict | None = Field(None, description="Parent published edition")
    signature: dict | None = Field(None, description="Edition digital signature")
    relations: list[dict] = Field(
        default_factory=list,
        description="Living relations (rectifies/supersedes/...) with canonical slugs",
    )
