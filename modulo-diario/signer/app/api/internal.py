...
async def sign_pdf(
    ...
    return SignResponse(
        ...
        timestamp_token_base64=result.timestamp_token_base64,
        timestamp_gen_time=result.timestamp_gen_time,
        timestamp_policy_oid=result.timestamp_policy_oid,
        timestamp_tsa_url=result.timestamp_tsa_url,
    )
