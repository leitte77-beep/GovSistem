...
function BotaoRail({ view, ativo, onClick, badge, somenteIcone }) {
  ...
  return React.createElement('button', {
    ...
    !somenteIcone && React.createElement('span', {
      style: {
        fontSize: 14.5, fontWeight: 'inherit',
  ...
  return React.createElement('aside', {
    ...
    React.createElement('div', { style: { marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 2 } },
      ...
      breakpoint === 'desktop' && React.createElement('button', {
        ...
        !somenteIcone && React.createElement('span', { style: { fontSize: 13.5, fontWeight: 600 } }, 'Recolher'),
      ),
      ...
      !somenteIcone && React.createElement('div', { style: { position: 'relative', marginTop: 4 } },
        React.createElement('button', {
          ...
          React.createElement('div', { style: { flex: 1, minWidth: 0 } },
            React.createElement('div', {
              style: { fontSize: 13.5, fontWeight: 700, color: T.text, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
            }, op?.nome || 'Usuário'),
            React.createElement('div', { style: { fontSize: 11.5, color: T.textMuted, fontWeight: 600 } }, papel),
          ),
        ),
