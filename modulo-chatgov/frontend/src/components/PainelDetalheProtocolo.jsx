...
export function PainelDetalheProtocolo({ protocolo, onClose, onAtualizado }) {
  ...
  var handleFileUpload = function (e) {
    ...
    fetch('/api/v1/protocols/' + proto.id + '/documents', { method: 'POST', headers: { Authorization: 'Bearer ' + token() }, body: formData })
  ...
  var downloadDocumento = function (doc) {
    var url = '/api/v1/protocols/' + proto.id + '/documents/' + doc.id + '/download';
