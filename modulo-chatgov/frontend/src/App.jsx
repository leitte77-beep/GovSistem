...
/*
 * Ponte do tema: assina o ThemeContext e recria os elementos da árvore inteira
 * a cada troca de tema. Sem isto, o ThemeProvider re-renderiza mas o elemento
 * `children` continua sendo o mesmo objeto, React faz bail-out e só os
 * componentes que chamam useTheme() trocam de cor — o resto da interface fica
 * com as cores antigas (estilos inline lidos do proxy `T` no render).
 */
function ArvoreApp() {
  useTheme();
