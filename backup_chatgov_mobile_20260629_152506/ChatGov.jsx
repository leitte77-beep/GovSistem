...
export function ChatGov() {
  ...
  const [view, setView] = useState(() => {
    const VIEWS_VALIDAS = ['atendimento', 'agenda', 'interno', 'relatorios', 'notificacoes', 'configuracoes'];
    try {
  ...
  const isFullScreen = ['configuracoes', 'notificacoes', 'relatorios'].includes(view);
  ...
  return React.createElement('div', {
    ...
    React.createElement(RailNavegacao, {
      view, onChange: handleChangeView, isAdmin, verRelatorios, notifCount,
    }),
