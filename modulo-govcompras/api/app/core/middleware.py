...
logger = logging.getLogger("govcompras.request")

_ROTAS_SILENCIOSAS = {
    "/api/govcompras/health",
    "/api/govcompras/health/live",
    "/api/govcompras/health/ready",
}
...
class RateLimitMiddleware(BaseHTTPMiddleware):
    """Janela deslizante em memória — suficiente para uma instância."""
