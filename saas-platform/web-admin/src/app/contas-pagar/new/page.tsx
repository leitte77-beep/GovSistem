...
export default function NewContaPagarPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.supplier_name.trim()) errs.supplier_name = "Fornecedor e obrigatorio";
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Registre uma nova despesa ou obrigacao financeira.</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="sm:col-span-2">
                ...
                <input
                  name="supplier_name" type="text" required
                  value={form.supplier_name} onChange={handleChange}
                  className={fieldClass("supplier_name")}
