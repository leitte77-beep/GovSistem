...
export default function EditContaReceberPage() {
  ...
  useEffect(() => {
    api<ReceivableData>(`/receivables/${id}`)
      .then((data) => {
        setForm({
      ...
      .catch(() => toast.error("Erro ao carregar conta a receber"))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.customer_name.trim() || !form.description.trim() || !form.amount || !form.due_date) {
  ...
  if (loading) {
    return (
      <AppLayout title="Editar Conta a Receber">
    ...
    <AppLayout title="Editar Conta a Receber">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Editar Conta a Receber</h2>
