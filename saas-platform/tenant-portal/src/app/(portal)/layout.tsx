      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex min-h-screen flex-col lg:ml-64" style={{ paddingTop: "3.5rem" }}>
          <main className="flex-1">
            <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-gutter sm:py-8">{children}</div>
          </main>
          <footer className="flex shrink-0 flex-col items-center justify-between gap-2 border-t border-outline-variant bg-surface-container-lowest px-4 py-3 text-center text-xs text-on-surface-variant sm:h-12 sm:flex-row sm:px-gutter sm:py-0 sm:text-left">
