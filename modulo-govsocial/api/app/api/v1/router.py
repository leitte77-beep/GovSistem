...
from app.api.v1.busca_ativa import router as busca_ativa_router

from app.api.v1.ai import router as ai_router
from app.api.v1.assinatura import router as assinatura_router
...
from app.api.v1.cadunico_consulta import router as cadunico_consulta_router
...
from app.api.v1.facial_recognition import router as facial_recognition_router
...
from app.api.v1.panic_button import router as panic_button_router
...
from app.api.v1.transparencia import router as transparencia_router
from app.api.v1.units import router as units_router
from app.api.v1.vigilancia_avancada import router as vigilancia_avancada_router

api_router = APIRouter()
api_router.include_router(ai_router)
api_router.include_router(assinatura_router)
api_router.include_router(facial_recognition_router)
...
api_router.include_router(cadunico_consulta_router)
...
api_router.include_router(transparencia_router)
