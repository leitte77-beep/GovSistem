...
api_router.include_router(medicoes_router, prefix="/convenios/{convenio_id}/medicoes")
api_router.include_router(medicoes_router, prefix="/demandas/{demanda_id}/medicoes")
