...
const STATIC_COMMANDS: Command[] = [
  { id: "novo-processo", label: "Novo processo", sub: "Criar convênio/processo", href: "/convenios/novo", icon: <FileText className="w-4 h-4" />, keywords: "criar novo convênio processo emenda" },
  ...
  { id: "coordenador", label: "Painel do coordenador", sub: "Central de coordenação", href: "/coordenador", icon: <ArrowUpDown className="w-4 h-4" />, keywords: "assessor coordenador painel" },
  { id: "executivo", label: "Painel executivo", sub: "Visão do gestor", href: "/executivo", icon: <ArrowUpDown className="w-4 h-4" />, keywords: "prefeito presidente gestor executivo" },
  ...
  { id: "prestacoes", label: "Prestações de contas", sub: "Status das prestações", href: "/prestacoes", icon: <FileText className="w-4 h-4" />, keywords: "prestação contas prestacao" },
  ...
  { id: "relatorios", label: "Relatórios", sub: "Consolidados", href: "/convenios/relatorios", icon: <FileText className="w-4 h-4" />, keywords: "relatório relatorios dossiê" },
