...
export default function DemandaDetalhePage() {
  ...
  const aplicarSugestao = async (campo: "resumo_executivo" | "proxima_acao", valor: string) => {
    try {
      await api.atualizarDemandaV2(id, { [campo]: valor });
      setDemanda({ ...demanda, [campo]: valor });
