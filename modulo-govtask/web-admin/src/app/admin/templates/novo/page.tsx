...
export default function NovoTemplatePage() {
  ...
  const [etapas, setEtapas] = useState<EtapaItem[]>([{ nome: "", natureza: "INTERNA" }]);
  ...
  if (!isAdmin) {
    return (
      <EmptyState
        ...
        description="Apenas administradores podem criar templates."
      />
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <PageHeader
        title="Novo Template de Fluxo"
        description="Defina o fluxo de etapas para um tipo de convênio"
        breadcrumbs={[
          { label: "Admin" },
