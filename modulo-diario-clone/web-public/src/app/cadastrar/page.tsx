...
export default function RegisterPage() {
  ...
  const BASE = (process.env.NEXT_PUBLIC_API_URL || "http://localhost:9201/api/v1").replace(/\/api\/v1$/, "");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const adminBase = process.env.NEXT_PUBLIC_ADMIN_URL || "http://localhost:9202";
